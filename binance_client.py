...
from binance.enums import KLINE_INTERVAL_15MINUTE, SIDE_BUY, SIDE_SELL
...
class BinanceTestnet:
    ...
    def get_snapshot(self, symbol: str, candles: int = 50) -> MarketSnapshot:
        ...
        raw = self.client.get_klines(
            symbol=symbol, interval=KLINE_INTERVAL_15MINUTE, limit=candles
        )
        parsed = [
            Candle(
